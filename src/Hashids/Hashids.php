...
class Hashids implements HashGenerator {
    ...
    public static function instance($length = null, $salt = null, $alphabet = null)
    {
        if (is_null(self::$instance)) {
            ...
            $length = function_exists('config') ? config("common.hashids.hashids_length") ? : 8 : 8;
            $salt = function_exists('config') ? config("common.hashids.hashids_key") ? : 'hashids' : 'hashids';
            $alphabet = function_exists('config') ? config("common.hashids.hashids_alphabet") ? : $str : $str;
